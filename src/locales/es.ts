export const es = {
  ...
  learn: {
    welcome: {
      title: "Aprende Hanab en 5 minutos",
      1: "¡Bienvenido! En este corto tutorial aprenderás a jugar por tu cuenta.",
      2: "No te preocupes, ¡Te guiaremos por todo el camino!",
    },
    cooperation: {
      title: "Cooperación",
      1: "Hanab es un juego cooperativo. \n\nJugarás junto con otros jugadores para alcanzar una meta en comun.",
    },
    colorBlind: {
      label: "¿Tienes problemas para visualizar los colores? Cambia al modo color-blind",
    },
    cards: {
      title: "Cartas",
      1: {
        1: "Las cartas estan numeradas desde",
        2: "a",
        3: "y coloreadas",
        4: "o",
      },
      2: "Al inicio del juego, cada jugador repartirá 5 cartas.",
      3: "No puedes ver tus cartas, pero puedes ver la de los otros jugadores",
    },
    goal: {
      title: "Meta",
      1: "Hay que jugar todas las cartas de cada color como un equipo.",
      2: "Las pilas de cada color deben construirse en orden ascendente.",
      3: "Por ejemplo, en el ejemplo previo, debes jugar",
      4: "antes de jugar",
      5: ".",
    },
    actions: {
      title: "Acciones",
      0: "En tu turno, puedes elegir entre 3 acciones",
      play: {
        title: "1. Jugar",
        1: "Jugar una carta de tu mano en la mesa.",
        2: "Si la carta no puede jugarse, la carta se descarta y tu equipo gana una ficha de ataque:",
        3: "Tomar una carta nueva de la baraja.",
      },
      hint: {
        title: "2. Pista",
        1: "Da indicaciones sobre las cartas en la mano de uno de tus compañeros de equipo.",
        2: "Dar una pista cuesta una ficha de pista:",
